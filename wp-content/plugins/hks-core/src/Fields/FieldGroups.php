...
final class FieldGroups {
	...
	private static function tour_package_group() {
		return self::group(
			...
			array(
				...
				self::field( 'tour_featured', __( 'Feature on the homepage', 'hks-core' ), 'hks_featured', 'true_false', array( 'instructions' => __( 'Includes this Tour in the homepage hero when its featured image is at least 1200 × 675 pixels, and moves it ahead of non-featured Tours in the Featured Tours grid.', 'hks-core' ), 'ui' => 1, 'default_value' => 0 ) ),
				self::field(
					'tour_from_price_ksh',
	...
	private static function settings_group() {
		...
		$fields = array(
			...
			self::public_setting( 'whatsapp_number', __( 'WhatsApp destination', 'hks-core' ), 'text', array( 'default_value' => '254712965131', 'required' => 1 ), __( 'Digits only in international format, without plus signs or spaces.', 'hks-core' ) ),
			self::public_setting( 'public_phone', __( 'Public phone number', 'hks-core' ), 'text', array( 'default_value' => '+254 712 965 131' ) ),
