...
final class Campaign {
	...
	private static function labels() {
		return array(
			...
			'featured_image'           => __( 'Campaign Lead Image', 'hks-core' ),
			'set_featured_image'       => __( 'Set campaign lead image', 'hks-core' ),
			'remove_featured_image'    => __( 'Remove campaign lead image', 'hks-core' ),
			'use_featured_image'       => __( 'Use as campaign lead image', 'hks-core' ),
